...
query_sql_dev = """select IDJOBPLAN, JOBNAME ,INSTANCIA ,PRIOSALI ,DATEPLAN ,FMINEJEC from DEXPPLAN d 
                ...
                and d.DATEPLAN <DATEADD(day, 8-DATEPART(weekday, '2023-09-21 16:30:36.290'), cast('2023-09-21 16:30:36.290' as date))"""
                
def connecte_to_db(SERVER,DATABASE,USERNAME,PASSWORD,query_sql_dev ):                
  ...
  return pd.read_sql(query_sql_dev,conn).to_excel('items.xlsx')
